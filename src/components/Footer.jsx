        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="space-y-1.5 text-xs mb-4">
              ...
              <p>📞 <a href="tel:+22507000000000" className="hover:text-[#c9933a] transition">+225 07 00 00 00 00</a></p>
              <p>✉️ <a href="mailto:contact@lecture-connaissance.ci" className="hover:text-[#c9933a] transition">contact@lecture-connaissance.ci</a></p>
              <p className="text-gray-500">Lun–Ven : 08h – 18h30 · Sam : 08h – 17h</p>
            </div>

            {/* Mini carte cliquable */}
            <a
              href="https://maps.google.com/?q=Cocody+Abidjan+Cote+d'Ivoire"
              target="_blank"
              rel="noopener noreferrer"
              className="block rounded-xl overflow-hidden border border-white/10 hover:border-[#c9933a] transition group"
            >
              <div className="relative" style={{height:'90px'}}>
                <iframe
                  title="Mini-carte magasin"
                  src="https://www.openstreetmap.org/export/embed.html?bbox=-4.0200%2C5.3450%2C-3.9750%2C5.3750&layer=mapnik&marker=5.3595%2C-3.9981"
                  width="100%" height="100%" style={{border:0, pointerEvents:'none'}} loading="lazy"
                />
                <div className="absolute inset-0 bg-[#c9933a]/0 group-hover:bg-[#c9933a]/10 transition flex items-center justify-center">
                  <span className="opacity-0 group-hover:opacity-100 bg-[#c9933a] text-white text-[10px] font-bold px-2 py-1 rounded-full transition">
                    Voir sur la carte →
                  </span>
                </div>
              </div>
